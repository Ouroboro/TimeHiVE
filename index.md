...
TimeHiVE provides efficient R functions for hierarchical moving-window
analysis of coupled time series data. The toolkit implements:
...
The software package here proposed allows to perform analyses on time
series avoiding the arbitrary choice of the time window and allowing to
...
coefficientes (Bottom Left) and relative p-values (Bottom Right). The
...
For functions `TH_plots` and `TH_plotc`, you can use significance values
...
[`TH_tweak()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_tweak.md)
and
[`TH_plott()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_plott.md)
allow you to use custom functions and possibly customize the color
...
- [`TH_single()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_single.md):
  Perform hierarchical moving-window analysis for single series
- [`TH_coupled()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_coupled.md):
  Perform hierarchical moving-window analysis for coupled series
- [`TH_tweak()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_tweak.md):
  Perform customized hierarchical moving-window analysis for coupled or
  single series
- [`TH_plots()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_plots.md):
  Visualize analysis results from
  [`TH_single()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_single.md)
- [`TH_plotc()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_plotc.md):
  Visualize analysis results from
  [`TH_coupled()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_coupled.md)
- [`TH_plott()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_plott.md):
  Visualize analysis results from
  [`TH_tweak()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_tweak.md),
  no masking.
- [`TH_MK_Trend()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_MK_Trend.md):
  Mann-Kendall trend test
- [`TH_MK_Corr()`](https://github.com/Ouroboro/TimeHiVE/reference/TH_MK_Corr.md):
...
(GPL-3.0). See the
[LICENSE](https://github.com/Ouroboro/TimeHiVE/LICENSE) file for
details.
