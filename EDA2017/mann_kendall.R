# Function to calculate the optimized Mann-Kendall test (O(n log^2 n)) based on Knight's method
...
# #TEST
# data_series <- c(1.2, 3.4, 2.5, 4.1, 5.6)
# result <- mann_kendall(data_series)
# cat("Mann-Kendall:\n")
# cat("S:", result$S, "\n")
# cat("Var S:", result$Var.S, "\n")
# cat("Z-score:", result$Z, "\n")
